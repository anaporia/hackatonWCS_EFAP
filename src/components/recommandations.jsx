      ...
      <div className='square col-12 d-flex justify-content-center'>
        <div className='col-8 tableStats'>
          ...
          <div className='row d-flex justify-content-center col-12 py-2'>
            {props.test.map(data => (
              <div key={data} className='col-2 m-2 subSquare'>
    ...
    return (
      <div className='container-fluid px-0'>
        ...
        <div className='row d-flex justify-content-center '>
          ...
          <Diagram className='d-flex justify-content-center' />
        </div>
        <div className='row'>
          <div className='col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2 espacePetition'>
            <Petition />
          </div>
        </div>
